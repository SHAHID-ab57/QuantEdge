...
hypotheses are exhausted; the A/B fork (Epic 4.2 / Milestone 5 vs an
order-flow / microstructure infrastructure bet) can now be made against
that. `docs/research/HORIZON_SWEEP_ASSESSMENT.md`.
