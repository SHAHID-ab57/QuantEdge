...
def test_real_market_data_api() -> None:
    ...
    with TestClient(create_app()) as client:
        ...
        timeframes = client.get(f"/api/v1/markets/{SYMBOL}/timeframes")
        ...
        latest = client.get(f"/api/v1/markets/{SYMBOL}/latest", params={"timeframe": TIMEFRAME})
