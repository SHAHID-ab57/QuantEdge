...
`app/repositories/paper_trading.py` (including the pre-trade risk limits'
own atomic concurrency guard, `try_apply_trade_effects`),
`app/models/paper_trading.py`, and `app/schemas/paper_trading.py`.
