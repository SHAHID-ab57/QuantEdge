...
The platform defines a set of generic user roles designed to be extensible as new
capabilities are introduced. Each role is characterized by its purpose, responsibilities,
permissions, and typical activities. Roles are conceptual definitions; the mechanisms by
which they are enforced are described elsewhere in this specification.
...
- Manage data retention, backups, and maintenance activities.
...
- Reviewing access logs and security events.
- Scheduling and verifying backups.

### Researcher

**Purpose:** Conduct quantitative research, develop and evaluate models, and produce
...
- Run backtests and validation workflows.
- Publish research results and findings.
...
- Conducting backtesting and walk-forward validation.
- Documenting experiments and publishing findings.

### Trader

**Purpose:** Use platform analytics to support decision-making and validate strategies
...
- Adhere to platform risk management guidelines.
...
- Run risk and scenario analyses.
...
- Exploring scenarios and risk assessments.

### Read-only Analyst

**Purpose:** Consume platform outputs for analysis, reporting, and decision support
